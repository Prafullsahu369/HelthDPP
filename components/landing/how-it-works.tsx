...
export function LandingHowItWorks() {
  const steps = [
    {
      ...
      description:
        "Patients securely upload their medical data through our encrypted interface. All files are automatically encrypted before storage.",
      icon: Upload,
    },
    {
  ...
  return (
    <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32 gradient-bg hexagon-grid">
          ...
          <div className="space-y-20">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="md:absolute md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 bg-primary text-primary-foreground rounded-full w-12 h-12 flex items-center justify-center font-bold z-10 glow-primary">
                  {index + 1}
                </div>
                <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                  ...
                  <div
                    className={`${index % 2 !== 0 ? "md:order-1" : ""} rounded-2xl overflow-hidden glass-effect shadow-lg`}
                  >
